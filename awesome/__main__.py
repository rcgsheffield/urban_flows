...
def main():
    ...
    reading_type_groups = sync.load_reading_category_config(args.reading_type_groups)
    ...
    with http_session.PortalSession(token_path=args.token) as session:
        ...
        sync.sync_aqi_standards(session, aqi_standards_file=args.aqi_standards_file)
