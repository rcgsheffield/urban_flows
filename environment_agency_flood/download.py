    ...
    def get_data(self, stations) -> iter:
        ...
        for station in stations:
            ...
            endpoint = 'id/stations/{station_id}/readings.csv'.format(
                station_id=get_value(station, "items_stationReference"))
            ...
            for row in reader:
                ...
                # Insert station info
                row['lat'] = get_value(station, "items_lat")
                row['long'] = get_value(station, "items_long")
                row['station'] = get_value(station, "items_@id")
